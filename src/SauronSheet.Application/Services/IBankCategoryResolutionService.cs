...
/// <summary>
/// Service that resolves raw bank category/subcategory values from a bank statement parser
...
public interface IBankCategoryResolutionService
{
    ...
    /// <param name="bankCategory">Raw bank category from bank statement (e.g. "Compras", "Aliment.").</param>
    /// <param name="bankSubcategory">Optional raw bank subcategory from bank statement.</param>
    ...
    /// category is always created for imported data.
    ///
